      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-12">
          <Reveal className="md:col-span-7 lg:col-span-8">
            <div className="img-frame min-h-[22rem] md:min-h-[26rem] lg:min-h-[30rem]">
              <Image
          ...
          <Reveal delayMs={100} className="rounded-3xl border border-border bg-background p-7 md:col-span-5 lg:col-span-4">
